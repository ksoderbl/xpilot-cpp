 ...
 * Energy drainage
 */
#define ED_SHOT_TIMES_256 (-0.2 * FUEL_SCALE_FACT)
#define ED_SMART_SHOT_TIMES_256 (-30 * FUEL_SCALE_FACT)
#define ED_MINE_TIMES_256 (-60 * FUEL_SCALE_FACT)
#define ED_ECM_TIMES_256 (-60 * FUEL_SCALE_FACT)
#define ED_TRANSPORTER_TIMES_256 (-60 * FUEL_SCALE_FACT)
#define ED_HYPERJUMP_TIMES_256 (-60 * FUEL_SCALE_FACT)
