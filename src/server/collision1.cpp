            ...
            for (j = i + 1; j < NumPlayers; j++)
            {
                ...
                if (Player_is_killed(pl_j))
                {
                    if (Player_is_killed(pl))
                    {
                        ...
                        {
                            Player *i_tank_owner_pl = Player_by_id(pl->lock.pl_id);
                        ...
                        {
                            Player *j_tank_owner_pl = Player_by_id(pl_j->lock.pl_id);
