...
#define NG_GAME_FONT "-*-fixed-bold-*-*--13-*-*-*-c-*-iso8859-1"
#define NG_MESSAGE_FONT "-*-fixed-bold-*-*--13-*-*-*-c-*-iso8859-1"
#define NG_SCORE_LIST_FONT "-*-fixed-bold-*-*--13-*-*-*-c-*-iso8859-1"
#define NG_BUTTON_FONT "-*-fixed-bold-*-*--13-*-*-*-c-*-iso8859-1"
...
static void Get_test_resources(XrmDatabase rDB)
{
    ...
    for (s = strtok(testBuffer, ":"); s != nullptr; s = strtok(nullptr, ":"))
    {
